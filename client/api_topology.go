...
func (r ApiIngestAgentAlertsRequest) RequestBody(requestBody []map[string]interface{}) ApiIngestAgentAlertsRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiIngestAgentAlertsRequest) Execute() (*http.Response, error) {
	return r.ApiService.IngestAgentAlertsExecute(r)
}

/*
IngestAgentAlerts Ingest Agent Alerts
...
func (a *TopologyAPIService) IngestAgentAlertsExecute(r ApiIngestAgentAlertsRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/ingest/alerts"
...
type ApiIngestAgentViolationsRequest struct {
	ctx context.Context
	ApiService *TopologyAPIService
	requestBody *[]map[string]interface{}
}

func (r ApiIngestAgentViolationsRequest) RequestBody(requestBody []map[string]interface{}) ApiIngestAgentViolationsRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiIngestAgentViolationsRequest) Execute() (*http.Response, error) {
	return r.ApiService.IngestAgentViolationsExecute(r)
}

/*
IngestAgentViolations Ingest Agent Violations

Ingest violation data reported by one Agent

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiIngestAgentViolationsRequest
*/
func (a *TopologyAPIService) IngestAgentViolations(ctx context.Context) ApiIngestAgentViolationsRequest {
	return ApiIngestAgentViolationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *TopologyAPIService) IngestAgentViolationsExecute(r ApiIngestAgentViolationsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopologyAPIService.IngestAgentViolations")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/ingest/violations"
