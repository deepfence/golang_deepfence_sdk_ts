...
type ApiIngestViolationsRequest struct {
	ctx context.Context
	ApiService *CloudResourcesAPIService
	ingestersNetworkViolation *[]IngestersNetworkViolation
}

func (r ApiIngestViolationsRequest) IngestersNetworkViolation(ingestersNetworkViolation []IngestersNetworkViolation) ApiIngestViolationsRequest {
	r.ingestersNetworkViolation = &ingestersNetworkViolation
	return r
}

func (r ApiIngestViolationsRequest) Execute() (*http.Response, error) {
	return r.ApiService.IngestViolationsExecute(r)
}

/*
IngestViolations Ingest Violations

Ingest violations

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiIngestViolationsRequest
*/
func (a *CloudResourcesAPIService) IngestViolations(ctx context.Context) ApiIngestViolationsRequest {
	return ApiIngestViolationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CloudResourcesAPIService) IngestViolationsExecute(r ApiIngestViolationsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudResourcesAPIService.IngestViolations")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.ingestersNetworkViolation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
