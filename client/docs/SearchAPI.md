...
> []ModelFileAlert SearchFileAlerts(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchFileAlertsRequest struct via the builder pattern
...
## SearchFilesystemAlertRules

> []ModelFilesystemAlertRule SearchFilesystemAlertRules(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchFilesystemAlertRulesRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSearchNetworkAlertsRequest struct via the builder pattern
...
## SearchNetworkViolations

> []ModelNetworkViolation SearchNetworkViolations(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchNetworkViolationsRequest struct via the builder pattern
...
## SearchProcessAlertRules

> []ModelProcessAlertRule SearchProcessAlertRules(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchProcessAlertRulesRequest struct via the builder pattern
...
> []ModelProcessAlert SearchProcessAlerts(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchProcessAlertsRequest struct via the builder pattern
...
## SearchQuarantineViolations

> []ModelQuarantineViolation SearchQuarantineViolations(ctx).SearchSearchNodeReq(searchSearchNodeReq).Execute()
...
Other parameters are passed through a pointer to a apiSearchQuarantineViolationsRequest struct via the builder pattern
