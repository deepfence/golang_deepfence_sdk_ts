...
func (o *ModelGenerativeAiIntegrationRuntimeIncidentRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varModelGenerativeAiIntegrationRuntimeIncidentRequest)
