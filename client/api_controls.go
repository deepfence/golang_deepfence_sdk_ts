...
type ApiInstallAgentOverCloudRequest struct {
	ctx context.Context
	ApiService *ControlsAPIService
	modelAgentInstall *ModelAgentInstall
}

func (r ApiInstallAgentOverCloudRequest) ModelAgentInstall(modelAgentInstall ModelAgentInstall) ApiInstallAgentOverCloudRequest {
	r.modelAgentInstall = &modelAgentInstall
	return r
}

func (r ApiInstallAgentOverCloudRequest) Execute() (*http.Response, error) {
	return r.ApiService.InstallAgentOverCloudExecute(r)
}

/*
InstallAgentOverCloud Control Agent Install on cloud

Control agent installation on cloud

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiInstallAgentOverCloudRequest
*/
func (a *ControlsAPIService) InstallAgentOverCloud(ctx context.Context) ApiInstallAgentOverCloudRequest {
	return ApiInstallAgentOverCloudRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ControlsAPIService) InstallAgentOverCloudExecute(r ApiInstallAgentOverCloudRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ControlsAPIService.InstallAgentOverCloud")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/controls/agent-install"
	...
	// body params
	localVarPostBody = r.modelAgentInstall
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiUninstallAgentOverCloudRequest struct {
	ctx context.Context
	ApiService *ControlsAPIService
	modelAgentInstall *ModelAgentInstall
}

func (r ApiUninstallAgentOverCloudRequest) ModelAgentInstall(modelAgentInstall ModelAgentInstall) ApiUninstallAgentOverCloudRequest {
	r.modelAgentInstall = &modelAgentInstall
	return r
}

func (r ApiUninstallAgentOverCloudRequest) Execute() (*http.Response, error) {
	return r.ApiService.UninstallAgentOverCloudExecute(r)
}

/*
UninstallAgentOverCloud Control Agent Uninstall on cloud

Control agent uninstallation on cloud

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUninstallAgentOverCloudRequest
*/
func (a *ControlsAPIService) UninstallAgentOverCloud(ctx context.Context) ApiUninstallAgentOverCloudRequest {
	return ApiUninstallAgentOverCloudRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ControlsAPIService) UninstallAgentOverCloudExecute(r ApiUninstallAgentOverCloudRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ControlsAPIService.UninstallAgentOverCloud")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/controls/agent-uninstall"
