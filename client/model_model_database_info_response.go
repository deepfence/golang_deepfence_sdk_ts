...
type ModelDatabaseInfoResponse struct {
	...
	NetworkAlertRulesUpdatedAt *time.Time `json:"network_alert_rules_updated_at,omitempty"`
...
// GetNetworkAlertRulesUpdatedAt returns the NetworkAlertRulesUpdatedAt field value if set, zero value otherwise.
func (o *ModelDatabaseInfoResponse) GetNetworkAlertRulesUpdatedAt() time.Time {
	if o == nil || IsNil(o.NetworkAlertRulesUpdatedAt) {
		var ret time.Time
		return ret
	}
	return *o.NetworkAlertRulesUpdatedAt
}

// GetNetworkAlertRulesUpdatedAtOk returns a tuple with the NetworkAlertRulesUpdatedAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelDatabaseInfoResponse) GetNetworkAlertRulesUpdatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.NetworkAlertRulesUpdatedAt) {
		return nil, false
	}
	return o.NetworkAlertRulesUpdatedAt, true
}
...
// SetNetworkAlertRulesUpdatedAt gets a reference to the given time.Time and assigns it to the NetworkAlertRulesUpdatedAt field.
func (o *ModelDatabaseInfoResponse) SetNetworkAlertRulesUpdatedAt(v time.Time) {
	o.NetworkAlertRulesUpdatedAt = &v
}
...
func (o ModelDatabaseInfoResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkAlertRulesUpdatedAt) {
		toSerialize["network_alert_rules_updated_at"] = o.NetworkAlertRulesUpdatedAt
	}
