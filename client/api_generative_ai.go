...
type ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest struct {
	ctx context.Context
	ApiService *GenerativeAIAPIService
	modelGenerativeAiIntegrationRuntimeIncidentRequest *ModelGenerativeAiIntegrationRuntimeIncidentRequest
}

func (r ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest) ModelGenerativeAiIntegrationRuntimeIncidentRequest(modelGenerativeAiIntegrationRuntimeIncidentRequest ModelGenerativeAiIntegrationRuntimeIncidentRequest) ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest {
	r.modelGenerativeAiIntegrationRuntimeIncidentRequest = &modelGenerativeAiIntegrationRuntimeIncidentRequest
	return r
}

func (r ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.GenerativeAiIntegrationRuntimeIncidentQueryExecute(r)
}

/*
GenerativeAiIntegrationRuntimeIncidentQuery Send Runtime Incident query to Generative AI Integration

Send Runtime Incident query to Generative AI Integration

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest
*/
func (a *GenerativeAIAPIService) GenerativeAiIntegrationRuntimeIncidentQuery(ctx context.Context) ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest {
	return ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *GenerativeAIAPIService) GenerativeAiIntegrationRuntimeIncidentQueryExecute(r ApiGenerativeAiIntegrationRuntimeIncidentQueryRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenerativeAIAPIService.GenerativeAiIntegrationRuntimeIncidentQuery")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/generative-ai-integration/query/alert"
	...
	// body params
	localVarPostBody = r.modelGenerativeAiIntegrationRuntimeIncidentRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
